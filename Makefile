...
#    Updated: 2023/06/21 14:20:27 by sbenes           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#sources
SRC_PATH =	src/
SRC = 	minishell.c prompt_crossroad.c builtin_echo.c builtins_cd_pwd.c builtin_env.c builtin_export.c builtin_unset.c utils.c parsing_quotes_env_vars.c executor_binary.c heredoc.c tokenize_commands_args.c in_outfiles.c command_check.c
