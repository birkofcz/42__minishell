...
#    Updated: 2023/06/26 17:43:36 by sbenes           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME): $(OBJS)
	...
	@echo ""
	@echo ""
	@echo "$(BCYAN) ___ _____ _____ ___           _       _     _          _ _  "
	@echo "$(BCYAN)|  _|_   _/  ___|_  |         (_)     (_)   | |        | | | "
	@echo "$(BCYAN)| |   | | \ ---.  | |_ __ ___  _ _ __  _ ___| |__   ___| | | "
	@echo "$(BCYAN)| |   | |  ---. \ | | '_   _ \| | '_ \| / __| '_ \ / _ \ | | "
	@echo "$(BCYAN)| |   | | /\__/ / | | | | | | | | | | | \__ \ | | |  __/ | | "
	@echo "$(BCYAN)| |_  \_/ \____/ _| |_| |_| |_|_|_| |_|_|___/_| |_|\___|_|_| "
	@echo "$(BCYAN)|___|           |___|                                        "
	@echo "$(BCYAN)																 "
	@echo ""
	@echo "$(NC)"
